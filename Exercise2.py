...
class PathIntegralMonteCarlo:
    def __init__(self, numerical_integral: NumericalPathIntegral, N_cf = 10000, w=1, eps=1.4, N_cor=20, source='x', imp='noghost'):
        """
        ...
        self.potential = numerical_integral.potential
...
if __name__ == '__main__':
    numerical_integral = NumericalPathIntegral(20, 0.5, 1, potential='anharmonic')
    ...
    for method in methods:
        sim = PathIntegralMonteCarlo(numerical_integral, imp=method)
        sim.run()
    ...
    for method in methods:
        ...
        t = np.arange(len(avgE)) * numerical_integral.a
